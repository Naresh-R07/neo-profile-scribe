      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6 animate-slide-in-left">
            <div className="relative w-64 h-64 mx-auto lg:w-full lg:h-96">
              <div className="absolute inset-0 bg-gradient-to-br from-primary/20 to-secondary/20 rounded-lg rotate-6"></div>
              <div className="relative h-full bg-card rounded-lg overflow-hidden border border-primary/30 scan-line">
                <img
